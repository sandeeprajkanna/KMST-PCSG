...
public class DatasetIndexer {
    ...
    private static void getPatternIndexes(String folder) {
        ...
        try{
            ...
            for (Set<Integer> pattern: EDP2ID.keySet()) {
                ...
                // we store classes and inproperty and outproperty
            ...
            for (List<Integer> triple: tripleList) {
                ...
                // for every triple we store Link pattern as <edp of sub,predicate,edp of obj> 
    ...
    public static void main(String[] args) {
        String folder = "D:/SEMESTER 8/KMST/Project_PCSG/code/example/"; // change to your local folder where there are graph.txt and label.txt files.
